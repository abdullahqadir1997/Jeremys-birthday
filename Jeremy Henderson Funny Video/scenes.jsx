...
function SceneOrigin() {
  ...
  return (
    <>
      ...
      <ExhibitPhoto src="assets/jeremy1.jpg" x={960} y={560} w={540} h={700} rotate={-2} frame={PARTY.electricYellow} shadow={PARTY.black} scale={0.9 + Math.sin(localTime * 2) * 0.02}/>
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <img src="assets/jeremy2.jpg" alt="" style={{
  ...
  return (
    <>
      ...
      <div style={{
        ...
        <img src="assets/jeremy3.jpg" alt="" style={{
  ...
  return (
    <>
      ...
      <div style={{
        ...
        <img src="assets/jeremy4.jpg" alt="" style={{
          width: '100%', height: '100%', objectFit: 'cover', display: 'block',
        }}/>
      </div>
  ...
  return (
    <>
      ...
      <div style={{
        ...
        <img src="assets/jeremy5.jpg" alt="" style={{
          width: '100%', height: '100%', objectFit: 'cover', display: 'block',
        }}/>
      </div>
  ...
  return (
    <>
      ...
      <div style={{
        ...
        <img src="assets/jeremy6.jpg" alt="" style={{
          width: '100%', height: '100%', objectFit: 'cover', display: 'block',
        }}/>
      </div>
  ...
  return (
    <>
      ...
      <div style={{
        ...
        <img src="assets/jeremy7.jpg" alt="" style={{
          width: '100%', height: '100%', objectFit: 'cover', display: 'block',
        }}/>
      </div>
...
function SceneFinale() {
  ...
  return (
    <>
      ...
      {/* ── The giant "45" — centered above cake with clear separation ── */}
      {localTime > 1.6 && (() => {
        ...
        return (
          <div style={{
            ...
            fontFamily: DISPLAY_FONT, fontSize: 170,
            color: PARTY.electricYellow,
      ...
      {/* ── CAKE — positioned so candle flames start ~280 (30px below "45") ── */}
      <div style={{
        position: 'absolute', left: '50%', top: 500,
        transform: 'translateX(-50%)', width: 680,
      }}>
        {/* Candles — positioned ABOVE the cake top tier */}
        <div style={{
          position: 'absolute', left: '50%', top: -160,
          transform: 'translateX(-50%)', display: 'flex', gap: 32,
        }}>
          {[0, 1, 2, 3, 4].map((i) => (
            <div key={i} style={{ position: 'relative' }}>
              ...
              {candleBlown && localTime < 4 && (
                <div style={{
                  position: 'absolute', left: '50%', top: -58 - (localTime - 2.2) * 60,
        ...
        {/* Top tier */}
        <div style={{
          width: 680, height: 110, background: PARTY.hotPink,
          border: `6px solid ${PARTY.black}`,
          borderRadius: '0 0 12px 12px',
          position: 'relative',
        }}>
          {[50, 160, 260, 360, 470, 580].map((x, i) => (
            <div key={i} style={{
              position: 'absolute', left: x, top: -18,
              width: 52, height: 32, background: PARTY.cream,
        ...
        {/* Bottom tier */}
        <div style={{
          width: 500, margin: '0 auto', height: 100, background: PARTY.cyan,
      ...
      {/* ── HAPPY BIRTHDAY JEREMY! — clean bottom block with proper spacing ── */}
      {localTime > 3.0 && (() => {
        const t = Math.min(1, (localTime - 3.0) / 0.5);
        const ease = 1 - Math.pow(1 - t, 3);
        return (
          <>
            {/* "HAPPY BIRTHDAY" — positioned with clear gap below cake (cake ends ~720) */}
            <div style={{
            ...
            {/* "JEREMY! 🎉" — below HAPPY BIRTHDAY with 30px gap (64 + 30 = 94 offset) */}
            <div style={{
              position: 'absolute', left: '50%', top: 858,
              transform: `translateX(-50%) scale(${ease})`,
              fontFamily: DISPLAY_FONT, fontSize: 120,
              color: PARTY.electricYellow,
              WebkitTextStroke: `5px ${PARTY.black}`,
              textShadow: `10px 10px 0 ${PARTY.hotPink}`,
              lineHeight: 1,
...
// ─────────────────────────────────────────────────────────────────────────────
// SCENE 11 — TEAM HENDERSON (Isabel + Jeremy) — humorous power rankings
function SceneTeam() {
  const { localTime } = useSprite();
  const stats = [
    { label: 'BEACH SUNSET GAME',     val: 'ELITE',      bar: 1.0, color: PARTY.orange,          who: 'ISABEL' },
    { label: 'TOLERATES DAD JOKES',   val: '10/10',      bar: 1.0, color: PARTY.lime,            who: 'ISABEL' },
    { label: 'KEEPS JEREMY IN LINE',  val: 'DAILY',      bar: 1.0, color: PARTY.hotPink,         who: 'ISABEL' },
    { label: 'JEREMY WITHOUT HER',    val: 'N/A',        bar: 0.05, color: PARTY.cyan,           who: 'JEREMY' },
    { label: 'COMBINED POWER LEVEL',  val: '∞',          bar: 1.0, color: PARTY.electricYellow,  who: 'TEAM'   },
  ];

  return (
    <>
      {/* sunset-party gradient bg */}
      <div style={{
        position: 'absolute', inset: 0,
        background: `linear-gradient(180deg, ${PARTY.deepPurple} 0%, ${PARTY.hotPink} 55%, ${PARTY.orange} 100%)`,
      }}/>
      ...
      <div style={{
        ...
        width: 2400, height: 2400,
        transform: `translate(-50%, -50%) rotate(${localTime * 8}deg)`,
        background: `repeating-conic-gradient(from 0deg, ${PARTY.electricYellow}18 0deg 12deg, transparent 12deg 24deg)`,
        opacity: 0.7,
      }}/>
      ...
      <div style={{
        ...
        transform: `rotate(-2deg) scale(${Math.min(1, localTime * 2.5)})`,
        fontFamily: DISPLAY_FONT, fontSize: 96,
        color: PARTY.electricYellow,
        WebkitTextStroke: `6px ${PARTY.black}`,
        textShadow: `10px 10px 0 ${PARTY.black}`,
        lineHeight: 0.95,
      }}>MEET<br/>ISABEL.</div>
      <div style={{
        position: 'absolute', left: 90, top: 280,
        transform: `rotate(-1deg)`,
        fontFamily: 'Caveat, cursive', fontSize: 48,
        color: PARTY.cream,
        opacity: Math.max(0, Math.min(1, (localTime - 0.5) * 2)),
        maxWidth: 640,
        lineHeight: 1,
      }}>...aka the real reason<br/>he has his life together.</div>

      {/* Photo — polaroid style, right-center */}
      <div style={{
        position: 'absolute', right: 90, top: '50%',
        transform: `translateY(-50%) rotate(${3 + Math.sin(localTime * 1.2) * 0.8}deg) scale(${Math.min(1, localTime * 2)})`,
        width: 520,
        background: PARTY.cream,
        padding: 22,
        paddingBottom: 90,
        border: `5px solid ${PARTY.black}`,
        boxShadow: `18px 18px 0 ${PARTY.black}, 24px 24px 0 ${PARTY.cyan}`,
      }}>
        <img src="assets/jeremy8.jpg" alt="" style={{
        ...
        <div style={{
          ...
          color: PARTY.black,
        }}>Isabel &amp; Jeremy — power couple 💪</div>

        {/* Floating hearts */}
        {[0, 1, 2, 3].map(i => {
          const delay = i * 0.25;
          const t = Math.max(0, localTime - 0.5 - delay);
          if (t <= 0) return null;
          return (
            <div key={i} style={{
              position: 'absolute',
              ...
              transform: `rotate(${Math.sin(t * 3 + i) * 15}deg)`,
              pointerEvents: 'none',
            }}>💖</div>
          );
        })}
      ...
      {/* Stats panel — bottom-left (Phase 1; fades out at 5.4s when Phase 2 takes over) */}
      {localTime < 5.8 && (() => {
        const fadeT = Math.max(0, Math.min(1, (localTime - 5.4) / 0.4));
        return (
      <div style={{
        position: 'absolute', left: 80, top: 440,
        width: 760,
        opacity: 1 - fadeT,
        transform: `translateX(${fadeT * -80}px)`,
      }}>
        <div style={{
          fontFamily: MONO, fontSize: 22,
          color: PARTY.electricYellow,
          ...
          marginBottom: 22,
          border: `3px solid ${PARTY.electricYellow}`,
        }}>📋 OFFICIAL TEAM POWER RANKINGS</div>

        {stats.map((s, i) => {
          const showT = 0.6 + i * 0.28;
          const show = localTime > showT;
          if (!show) return null;
          const fillT = Math.min(1, (localTime - showT) * 2);
          const fill = s.bar * fillT;
          return (
            <div key={i} style={{
              marginBottom: 14,
              ...
              border: `3px solid ${PARTY.black}`,
              padding: '10px 14px',
              opacity: Math.min(1, (localTime - showT) * 3),
            }}>
              <div style={{
                ...
                <span>
                  <span style={{
                    color: s.who === 'ISABEL' ? PARTY.hotPink : s.who === 'JEREMY' ? PARTY.cyan : PARTY.electricYellow,
                    marginRight: 10,
                    fontWeight: 700,
                  }}>[{s.who}]</span>
                  {s.label}
      ...
      {/* Footer verdict — appears at end of phase 1 */}
      {localTime > 3.6 && (() => {
        const t = Math.min(1, (localTime - 3.6) / 0.4);
        const ease = 1 - Math.pow(1 - t, 3);
        // Slide down/out when bonus stats arrive
        const exitT = Math.max(0, Math.min(1, (localTime - 5.4) / 0.4));
        return (
          <div style={{
            position: 'absolute', left: '50%', bottom: 40 - exitT * 200,
            transform: `translateX(-50%) rotate(-1deg) scale(${ease}) ${exitT > 0 ? `translateY(${exitT * 120}px)` : ''}`,
            background: PARTY.electricYellow,
            padding: '14px 32px',
            border: `5px solid ${PARTY.black}`,
            boxShadow: `10px 10px 0 ${PARTY.hotPink}`,
            ...
            whiteSpace: 'nowrap',
            opacity: 1 - exitT,
          }}>VERDICT: TEAM HENDERSON = PERFECT STATS 💍</div>
        );
      })()}

      {/* ── PHASE 2 (5.8s+) — BONUS STATS cascade in after the verdict slides away ── */}
      {localTime > 5.8 && (() => {
        const bonusStats = [
          { label: 'LAUGHS AT JEREMY\'S JOKES',  val: '40% (GENEROUS)', color: PARTY.hotPink },
          { label: 'BEACH SUNSET PHOTOGRAPHER',  val: 'OF THE YEAR',    color: PARTY.orange },
          { label: 'KNOWS WHERE HIS KEYS ARE',   val: 'ALWAYS',         color: PARTY.lime },
          { label: 'REMEMBERS BIRTHDAYS',        val: 'BOTH OF THEM',   color: PARTY.cyan },
          { label: 'PATIENCE WITH JIU-JITSU TALK', val: 'LEGENDARY',    color: PARTY.electricYellow },
        ];
        return (
          <div style={{
            position: 'absolute', left: 80, top: 440,
            ...
            <div style={{
              ...
              marginBottom: 22,
              border: `3px solid ${PARTY.black}`,
              transform: `rotate(${Math.sin(localTime * 2) * 1.5}deg)`,
            }}>✨ BONUS STATS — STILL COUNTING...</div>

            {bonusStats.map((st, i) => {
              const showT = 6.0 + i * 0.3;
              if (localTime < showT) return null;
              const inT = Math.min(1, (localTime - showT) * 3);
              return (
                <div key={i} style={{
                  marginBottom: 12,
                  ...
                  <div style={{
                    ...
                    <span>
                      <span style={{ color: PARTY.hotPink, marginRight: 10, fontWeight: 700 }}>[ISABEL]</span>
                      {st.label}
                    </span>
                    <span style={{ color: st.color, fontWeight: 700 }}>{st.val}</span>
                  </div>
                </div>
              );
            })}
      ...
      {/* ── PHASE 2 footer — "CONCLUSION: JEREMY WON THE LOTTERY" ── */}
      {localTime > 7.8 && (() => {
        const t = Math.min(1, (localTime - 7.8) / 0.5);
        const ease = 1 - Math.pow(1 - t, 3);
        return (
          <div style={{
            position: 'absolute', left: '50%', bottom: 40,
            transform: `translateX(-50%) rotate(2deg) scale(${ease})`,
            background: PARTY.hotPink,
            padding: '16px 36px',
            border: `5px solid ${PARTY.black}`,
            boxShadow: `10px 10px 0 ${PARTY.electricYellow}`,
            fontFamily: DISPLAY_FONT, fontSize: 42,
            color: PARTY.cream,
            textAlign: 'center',
            whiteSpace: 'nowrap',
            textShadow: `4px 4px 0 ${PARTY.black}`,
          }}>CONCLUSION: JEREMY HIT THE JACKPOT 🎰</div>
        );
      })()}
    </>
  );
...
function BirthdayVideo() {
  ...
  return (
    <>
      ...
      <Sprite start={37} end={47}><SceneTeam/></Sprite>
      <Sprite start={47} end={51}><SceneWarning/></Sprite>
      <Sprite start={51} end={57}><SceneFinale/></Sprite>
      ...
      <Sprite start={37} end={47}>
        <Confetti count={Math.round(40 * confettiMult)} seed={5} colors={[PARTY.hotPink, PARTY.cream, PARTY.electricYellow]}/>
      </Sprite>
      <Sprite start={53} end={57}>
